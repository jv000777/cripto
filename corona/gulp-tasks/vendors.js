...
gulp.task('buildOptionalVendorScripts', function () {
    ...
    var aScript26 = gulp.src(['../node_modules/inputmask/dist/jquery.inputmask.min.js'])
    ...
    var aScript36 = gulp.src(['../node_modules/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js'])
    ...
    var aScript68 = gulp.src(['../node_modules/nouislider/dist/nouislider.min.js'])
    ...
    var aScript72 = gulp.src(['../node_modules/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js'])
        .pipe(gulp.dest('./assets/vendors/bootstrap-datepicker/datetime'))
...
gulp.task('buildOptionalVendorStyles', function () {
    var aStyle1 = gulp.src(['../node_modules/@mdi/font/css/dv'])
    ...
    var aStyle49 = gulp.src(['../node_modules/jquery-toast-plugin/dist/jquery.toast.min.css'])
        .pipe(gulp.dest('./assets/vendors/jquery-toast-plugin'));
    var aStyle50 = gulp.src(['../node_modules/nouislider/dist/nouislider.min.css'])
        .pipe(gulp.dest('./assets/vendors/nouislider'));
...
gulp.task('copyMapFiles', function () {
    ...
    var map12 = gulp.src('../node_modules/jquery-bar-rating/dist/jquery.barrating.min.js.map')
        .pipe(gulp.dest('./assets/vendors/jquery-bar-rating'));
    return merge(map1, map2, map3, map4, map5, map6, map7, map8, map9, map10, map11, map12);
});
